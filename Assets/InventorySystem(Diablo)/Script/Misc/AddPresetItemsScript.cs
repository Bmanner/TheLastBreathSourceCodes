...
public class AddPresetItemsScript : MonoBehaviour {
    ...
    public List<GameObject> gridItems;  // 글로벌일 필요가 없으므로 private로 변경하니 문제가 발생. 
                                        // 다음 링크가 원인 https://forum.unity.com/threads/cant-add-child-transforms-to-private-list-but-public-list-works-fine.447558/
